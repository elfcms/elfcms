        ...
        <form action="{{ route('admin.user.users.store') }}" method="POST">
            ...
            <div class="colored-rows-box">
                ...
                <div class="input-box colored">
                    ...
                    <div class="input-wrapper">
                        <x-elfcms::ui.checkbox.switch name="is_confirmed" id="is_confirmed"
                            checked="{{ !empty(old('is_confirmed')) }}" />
                    </div>
                </div>
            </div>
            ...
            <div class="roles-list">
                ...
                @foreach ($roles as $role)
                    <div class="input-box">
                        ...
                        <div class="input-wrapper">
                            <x-elfcms::ui.checkbox.switch name="role[]" id="role_{{ $role->id }}"
                                checked="{{ $role->code == $default_role_code }}" />
                        </div>
                    </div>
                @endforeach
            </div>
