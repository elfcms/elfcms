        ...
        <form action="{{ route('admin.page.pages.update', $pageData->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="colored-rows-box">
                ...
                <div class="input-box colored">
                    ...
                    <x-elfcms::ui.checkbox.switch name="is_dynamic" id="is_dynamic" checked="{{!empty($pageData->is_dynamic)}}" />
                </div>
                <div class="input-box colored">
                ...
                <div class="input-box colored">
                    ...
                    <div class="input-wrapper">
                        <x-elf-input-file value="{{ $pageData->image }}" :params="['name' => 'image', 'value_name' => 'image_path']" :download="true" />
                    </div>
                </div>
                <div class="input-box colored">
